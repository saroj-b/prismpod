        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              <Route exact path="/addcandidate" render={(props) => <AddCandidate {...props} auth={authProps} />} />
              <Route exact path="/projectsignup" render={(props) => <ProjectSignupEp {...props} auth={authProps} />} />
              ...
              <Route exact path="/candidatehome" render={(props) => <CandidateHome {...props} auth={authProps} />} />
              <Route exact path="/employerhome" render={(props) => <EmployerHome {...props} auth={authProps} />} />
